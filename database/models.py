...
class UserBotAccount(Base):
    ...
    gift_media: Mapped[str] = mapped_column(Text, default="[]")
    followup2_text: Mapped[str] = mapped_column(Text, default="")
    followup2_parse_mode: Mapped[str] = mapped_column(String(16), default="HTML")
    followup2_entities: Mapped[str] = mapped_column(Text, default="[]")
    followup3_text: Mapped[str] = mapped_column(Text, default="")
    followup3_parse_mode: Mapped[str] = mapped_column(String(16), default="HTML")
    followup3_entities: Mapped[str] = mapped_column(Text, default="[]")
...
class UserBotLead(Base):
    ...
    followup2_replied: Mapped[bool] = mapped_column(Boolean, default=False)
    followup3_replied: Mapped[bool] = mapped_column(Boolean, default=False)
