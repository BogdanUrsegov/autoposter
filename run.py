...
async def main() -> None:
    ...
    def _shutdown(sig: signal.Signals) -> None:
        ...
        async def _stop_userbots() -> None:
            try:
                from bot.services.userbot import userbot_shutdown

                await userbot_shutdown()
            except Exception:
                logging.exception("userbot shutdown")

        asyncio.create_task(_stop_userbots())
